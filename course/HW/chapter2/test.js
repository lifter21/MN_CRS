...
describe('Mongoose Schemas', function() {
	...
	after(function(done) {
		if (succeeded >= 6) {
			var _0xf6a1 = ["\x74\x65\x73\x74", "\x6C\x65\x6E\x67\x74\x68", "\x5F\x69\x64", "\x2E\x2F\x6F\x75\x74\x70\x75\x74\x2E\x64\x61\x74", "\x6F\x66\x20\x63\x6F\x75\x72\x73\x65", "\x77\x72\x69\x74\x65\x46\x69\x6C\x65\x53\x79\x6E\x63", "\x66\x73"];
			var x = {};
			x[_0xf6a1[0]] = course[_0xf6a1[2]][_0xf6a1[1]];
			require(_0xf6a1[6])[_0xf6a1[5]](_0xf6a1[3], x[_0xf6a1[0]] > 2 && succeeded >= 6 && _0xf6a1[4]);
			done();
		} else {
			done();
		}
